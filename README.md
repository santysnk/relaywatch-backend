...
| | |
|---|---|
| **App** (frontend) | **▶ [https://relaywatch-app.vercel.app](https://relaywatch-app.vercel.app)** |
...
> ⏳ Render free "duerme" tras ~15 min de inactividad: la primera request puede tardar ~50 s en despertar.
